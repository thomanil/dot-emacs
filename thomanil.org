...
#+begin_src emacs-lisp
(defun custom-persp/starbridge ()
  (interactive)
  (custom-persp "starbridge"
		(dired "/home/thomanil/versioncontrolled/private/starbridge")
		...
		(other-window 1)
                ...
                (cd "/home/thomanil/versioncontrolled/private/starbridge")
	        (async-shell-command "scripts/server" "*server*")
                (async-shell-command "keeptesting -p . 'test failed|SyntaxError|errors' 'rake test lint'" "*autotest*")))
#+end_src
...
TODO: use my org2html binary in orgtools gem instead of this
