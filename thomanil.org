...
#+begin_src emacs-lisp
(fset 'hack-on-kensei
  [?\C-x ?\C-f ?~ ?/ ?v ?e ?r ?i ?o ?n ?c ?o ?n return ?p ?u ?b ?l return ?k ?e ?n ?s ?e ?i return ?k ?e ?n ?s ?e ?i ?. ?e ?l return ?\C-x ?3 S-right ?\C-x ?\C-f ?k ?e ?n ?s ?e ?i ?. ?e ?l return S-left ?\C-x ?\C-f ?k ?e ?n ?s ?e ?i ?- ?t ?e return ?\C-x ?2 ?\C-x ?\C-f ?t ?o ?d ?o ?. ?o ?r ?g return])
#+end_src
