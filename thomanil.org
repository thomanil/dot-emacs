...
(defun new-orgletter ()
  (interactive)
  (let ((name (concat "~/Dropbox/orgfiles/tmp-orgfiles/" (read-string "New org file: " "tmp.org"))))
    (find-file "~/Dropbox/orgfiles/tmp-orgfiles/_template.org")
    (write-file name)))
...
(defun export-my-orgfiles ()
  ...
  (interactive)
  (org-publish (quote
	      ("orgfiles" :base-directory "~/Dropbox/orgfiles"
	       :base-extension "org"
	       :publishing-directory "~/Dropbox/orgfiles/exported-html"
	       :htmlized-source t
	       :recursive t
